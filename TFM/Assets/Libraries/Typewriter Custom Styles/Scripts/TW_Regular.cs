...
public class TW_Regular : MonoBehaviour {
    ...
    public UnityEvent FinalEscrituraEvent;
    ...
    private IEnumerator MakeTypewriterText(string ORIGINAL, string POINTER)
    {
        ...
        {
            StartCoroutine(InvocaFinalEscrituraConDelay());
        }
    }

    private IEnumerator InvocaFinalEscrituraConDelay()
    {
        print("Invodcando final escritura");
        yield return new WaitForSeconds(4);
        if (FinalEscrituraEvent!=null)
        {
            FinalEscrituraEvent.Invoke();
        }
    }
